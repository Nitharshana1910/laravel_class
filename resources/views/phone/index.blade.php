...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            <h1 style="margin-top: 20px;">All Phone Numbers</h1>
            </div>
            
            <div class="col-md-4">
                <a href="{{ route('phones.create') }}" class="btn btn-lg btn-block btn-primary btn-h1-spacing" style="margin-top: 20px;">Create Phone Number</a>
                <hr>
            </div>       
        </div>
                    ...
                    <tbody>
                        @foreach ($phones as $phone)
                            <tr>
                                ...
                                <td>
                                   <a href="{{ route('phones.show',$phone->id) }}" class="btn btn-info btn-sm">View</a> 
