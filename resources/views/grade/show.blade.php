...
<body>
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="row">
            <div class="col-md-8">
                <h3 style="text-align: center">Grade Name: {{ $grade->grade_name }}</h3>
            </div>
            ...
            <div class="col-md-4">
                <div class="well">
                    <dl class="dl-horizontal">
                        ...
                        <p>{{ date('M j,Y h:ia', strtotime($grade->created_at)) }}</p>
                    </dl>
                    <dl class="dl-horizontal">
                        <label>Last Updated:</label>
                        <p>{{ date('M j,Y h:ia', strtotime($grade->updated_at)) }}</p>
                    </dl>
                    <hr>
                    <div class="row">
                        <div class="col-sm-6">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('grades.index') }}" class="btn btn-info btn-sm">Back</a>
