...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            <h1 style="margin-top: 20px;">All Teachers</h1>
            </div>
            
            <div class="col-md-4">
                <a href="{{ route('teachers.create') }}" class="btn btn-lg btn-block btn-primary btn-h1-spacing" style="margin-top: 20px;">Create Teacher</a>
                <hr>
            </div>       
        </div>
