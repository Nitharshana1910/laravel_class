...
<body>
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="row">
            <div class="col-md-8">
                <h3 style="text-align: center">Teacher Name: {{ $teacher->name }}</h3>
                <h3 style="text-align: center">Phone ID: {{ $teacher->phone_id }}</h3>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('teachers.index') }}" class="btn btn-info btn-sm">Back</a>
